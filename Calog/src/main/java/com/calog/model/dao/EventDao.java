...
public interface EventDao {
    ...
    List<Event>selectEventBySport( @Param("sport")String sport);
    List<Event>selectEventByCity(@Param("city")String city);
    List<Event>selectEventBySportAndCity(@Param("sport")String sport,@Param("city")String city);
